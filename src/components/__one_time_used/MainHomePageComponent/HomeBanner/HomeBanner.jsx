        ...
        <div className="full__section_l_p pr-3 md:pr-0 banner__section">
          <div className="banner-content grid grid-cols-1 md:grid-cols-8 items-center gap-10 pt-[20px] md:py-[75px] lg:py-[95px] xl:py-[120px] 2xl:pt-[145px] 3xl:pt-[170px] 4xl:pt-[195px] 5xl:py-[220px]">
            <div className="md:col-span-4 flex items-center">
              <div className="px-6">
                <h1 className="text-4xl lg:text-[40px] xl:text-[44px] 2xl:text-[48px] 3xl:text-[54px] 4xl:text-[58px] 5xl:text-[65px] text-black font-bold text-left leading-tight">
                ...
                <div className="flex justify-start py-6">
                  ...
                  >
                    <span className="flex justify-center items-center gap-2 mr-2 text-white text-base font-bold">
                      Get Estimated
                      <svg
